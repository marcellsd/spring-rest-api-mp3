...
public class ClienteController {
    ...
    public Cliente updateCliente(@PathVariable Integer id,
       ...
       return clientes.findById(id)
        .map( oldCliente -> {
            if (cliente.getNome() != null) oldCliente.setNome(cliente.getNome());
            if (cliente.getCpf() != null) oldCliente.setCpf(cliente.getCpf());
            if (cliente.getPedidos() != null) oldCliente.setPedidos(cliente.getPedidos());
            clientes.save(oldCliente);
            return oldCliente;
        }).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND,
        "Cliente não encontrado") );
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public ClientePedidosDTO listarPedidosByID(@PathVariable Integer id){
       return service.getClientePedidos(id);
    }
